...
//   console.log(categories);
  ...
  categories.forEach((categorie) => {
    ...
    div.innerHTML = `
            <button  onclick= "allShow('${categorie.category_id}')" class="btn text-base font-medium px-5 w-24 focus:outline-none focus:bg focus:bg-red-600 focus:text-white">${categorie.category}</button>
         `;
...
//---------------------data sorting-------------------------------------
  ...
  if(sort){
    allData.sort((a, b) => b.others.views.slice(0, -1) - a.others.views.slice(0, -1)) 
}
